...
class App extends Component {
  ...
  render() {
    return (
      <div>
        <AppBar iconElementLeft={<div />} title="US Census Visualization" />
        <Row>
          <p>
            Variable:
          </p>
          ...
          <Comment>
            {this.props.datas.rowsNumber > 100
              ? `Non displayed rows: ${this.props.datas.rowsNumber - 100}`
              : null}
          </Comment>
        </Row>
        <div>
